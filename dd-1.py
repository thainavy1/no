...
clPoll = OEPoll(cl)
#==============================================================================================================
creator = ["ueac4f75a97784ec1aa8083146498a5e8"] 
owner = ["ueac4f75a97784ec1aa8083146498a5e8"]
admin = ["ueac4f75a97784ec1aa8083146498a5e8"]
staff = ["ueac4f75a97784ec1aa8083146498a5e8"]
...
wait = {
    ...
    "dellbots":False,
    "blacklist":{
        "u1058ad8ef2ea19a5d4c02452694769": True,
        "u1058ad8ef2ea19a5d4c02452694769": True,
        "u1058ad8ef2ea19a5d4c02452694769": True
    },
    "wblacklist":False,
...
#-------------------------------------------------------------------------------    
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  sendMention(op.param1, op.param1, "หน้าหี")
                 ...
                 if text is None:
                     return
                        ...
                        if cmd == "selfbot on":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                cl.sendText(msg.to, "เปิดเซลบอทแล้ว")
                                
                        elif cmd == "selfbot off":
                            if msg._from in admin:
                                wait["selfbot"] = False
                                cl.sendText(msg.to, "ปิดเซลบอทแล้ว")
                        ...
                        elif cmd.startswith("เกี่ยวกับกลุ่ม "):
                          if msg._from in admin:
                            separate = text.split(" ")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                if msg.toType == 2:
                                   ...
                                   cl.updateGroup(X)
                                   cl.sendMessage(msg.to, "เปิดลิ้งสำเร็จ")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                if msg.toType == 2:
                                   ...
                                   X.preventedJoinByTicket = True
                                   cl.updateGroup(X)
                                   cl.sendMessage(msg.to, "ปิดลิ้งสำเร็จ")
...
#===========Protection============#
                        ...
                        elif 'เปิดหมด ' in msg.text:
                           if msg._from in admin:                             
                              spl = msg.text.replace('เปิดหมด ','')
                              if spl == 'on':
                                  ...
                                  if msg.to in protectcancel:
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "Status : [ ON ]\nDi Group : " +str(ginfo.name)
                                      msgs += "\nเปิดระบบป้องกันทั้งหมดแล้วแล้ว"
                                  else:
                                      protectcancel.append(msg.to)
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "Status : [ ON ]\nDi Group : " +str(ginfo.name)
...
#===========ADMIN ADD============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           Bots.append(target)
                                           cl.sendMessage(msg.to,"เพิ่มบอทสำเร็จ")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Saints:
                                       try:
                                           admin.remove(target)
                                           cl.sendMessage(msg.to,"ลบออกจากการเป็นแอดมินสำเร็จ")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Saints:
                                       try:
                                           Bots.remove(target)
                                           cl.sendMessage(msg.to,"ลบออกจากบอทสำเร็จ")
                                       except:
                                           pass
                        ...
                        elif cmd == "เช็คแอด" or text.lower() == 'contact admin':
                            if msg._from in admin:
                                ma = ""
                                for i in admin:
                                    ma = cl.getContact(i)
                        ...
                        elif cmd == "เช็คบอท" or text.lower() == 'contact bot':
                            if msg._from in admin:
                                ma = ""
                                for i in Bots:
                                    ma = cl.getContact(i)
...
#===========COMMAND ON OFF============#
                        ...
                        elif text.lower() == 'เปิดอ่านคท':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = True
                                cl.sendText(msg.to,"เปิดระบบอ่านคอนแทคแล้ว")

                        elif text.lower() == 'ปิดอ่านคท':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = False
                                cl.sendText(msg.to,"ปิดระบบอ่านคอนแทคแล้ว")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = True
                                cl.sendText(msg.to,"เปิดระบบบล็อคอัตโนมัตแล้ว")

                        elif text.lower() == 'ปิดบล็อค':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = False
                                cl.sendText(msg.to,"ปิดระบบบล็อคอัตโนมัตแล้ว")
...
#===========COMMAND BLACKLIST============#
                        ...
                        elif cmd == "คนติดดำ" or text.lower() == 'banlist':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
